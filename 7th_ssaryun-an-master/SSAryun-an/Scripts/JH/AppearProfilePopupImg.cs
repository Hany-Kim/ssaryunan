...
public class AppearProfilePopupImg : MonoBehaviour
{
    public RawImage img;
    ...
    public void OnClickProfilePopup()
    {
     ...
     //   userName.text = DataManager.instance.nowPlayer.name;
    }
