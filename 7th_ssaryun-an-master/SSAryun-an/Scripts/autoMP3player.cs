...
public class autoMP3player : ARBehaviour
{
	private Dictionary<string, testtesttest> imageTrackablesMap =
		new Dictionary<string, testtesttest>();
	...
	void Start()
	{
		...
		testtesttest[] imageTrackables = FindObjectsOfType<testtesttest>();
